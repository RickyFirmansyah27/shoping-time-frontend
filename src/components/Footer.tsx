    ...
    <footer className="bg-white border-t mt-auto">
      <div className="container mx-auto px-4 py-8">
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
          <div>
            <h3 className="font-bold text-lg mb-4">ShopingTime</h3>
          ...
          <div>
            ...
            <ul className="space-y-2">
              <li>
                {isClient && (
                  <a
                    ...
                    className="text-sm text-gray-600 hover:text-ecommerce-primary"
                  >
                    Contact Us
                  </a>
                )}
              ...
              <li>
                {isClient && (
                  <Link to="/" className="text-sm text-gray-600 hover:text-ecommerce-primary">
                    FAQ
                  </Link>
                )}
              </li>
        ...
        <div className="border-t mt-8 pt-6 text-center text-sm text-gray-600">
          <p>&copy; {new Date().getFullYear()} ShopingTime. All rights reserved.</p>
        </div>
      </div>
    </footer>
  );
